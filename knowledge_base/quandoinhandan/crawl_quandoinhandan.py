...
def crawl_article(url):
    ...
    # date
    date_tag = soup.select_one(".post-subinfo span")
...
def main():
    ...
    with open("../../link/raw/combine/quandoinhandan_CT.txt", "r", encoding="utf-8") as f:
        urls_CT = [line.strip() for line in f if line.strip()]

    with open("../../link/raw/combine/quandoinhandan_TG.txt", "r", encoding="utf-8") as f:
    ...
    with open("KB_quandoinhandan.json", "w", encoding="utf-8") as f:
